    ...
    internal static class AzureCli
    {
        ...
        internal static bool GetExtensionsInstalledList()
        {
            ...
            if (azCliExtensionEntity != null)
            {
                ...
                AnsiConsole.Write(Components.Table.Show(true, "[aqua]Azure Installed Extensions[/]", string.Empty, columns, rows));
        ...
        internal static bool GetExtensionsAvailableList()
        {
            ...
            if (azCliExtensionEntity != null)
            {
                ...
                AnsiConsole.Write(Components.Table.Show(true, "[aqua]Azure Available Extensions[/]", string.Empty, columns, rows));
                AnsiConsole.Write(new Markup("[green]Press any key to back.[/]"));
                _ = Console.ReadKey();
                return true;
            }
